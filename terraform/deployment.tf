...
resource "kubernetes_service" "weatherapi-mfe" {
  ...
  metadata {
    ...
    annotations = {
      ...
      "alb.ingress.kubernetes.io/actions.forward-single-tg": "{\"type\":\"authenticate\",\"targetGroupARN\": \"arn:aws:elasticloadbalancing:us-west-2:921881026300:targetgroup/b5273caa-c67dfcbbefe791fd6b6/4e2a959fc1c5c6c0\"}"
    }
  }
  spec {
    rule {
